/**
 * @file revokeDidRole.ts
 * @description Hardhat task to revoke a role from a DID
 * @module tasks/accessControlDid
 */

/**
 npx hardhat revokeDidRole --network localhost \
...
import { revokeDidRole } from '../../scripts/accessControlDid/revokeDidRole'
import { SignatureProviderFactory } from '../deployment/providers/SignatureProviderFactory'

task('revokeDidRole', 'Revokes a role from a DID (requires role admin)')
    ...
    .setAction(async (taskArgs, hre: HardhatRuntimeEnvironment) => {
        ...
        return revokeDidRole(role, did, diamond, signatureProvider)
    })
