import { addValidatorStandby } from '../../../scripts/client/besuNodeManager/addValidatorStandby'
...
/*
npx hardhat addValidatorStandby \
...
task(
    ...
    .setAction(
        async (
            ...
            console.info('ADD VALIDATOR STANDBY TASK')
            console.log(`Adding Besu Validator Node in Standby state:`)
