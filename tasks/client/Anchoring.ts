import {
    ...
    anchorBlock,
    anchorBlocksBatch,
} from '../../scripts/client/anchoringCoreFacet'
    ...
    const tasks = [
        {
            ...
            example:
                'npx hardhat anchoringcorefacet:getregisteredchains --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --pageindex 0 --pagelength 10',
        },
        {
            ...
            example:
                'npx hardhat anchoringcorefacet:getchainmetadata --network <network> --governancediamond 0x00000000000000000000000000000000000015BE',
        },
        {
            ...
            example:
                'npx hardhat anchoringcorefacet:getanchoringstats --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1',
        },
        {
            ...
            example:
                'npx hardhat anchoringcorefacet:getblocksinrange --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1 --fromblock 100 --toblock 110',
        },
        {
            ...
            example:
                'npx hardhat anchoringcorefacet:getlastnblocks --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1 --count 5',
        },
        {
            ...
            example:
                'npx hardhat anchoringcorefacet:isblockanchored --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1 --blocknumber 100',
        },
        {
            ...
            params: '--governancediamond <address> --chainid <uint256> --blocknumber <uint256>',
            example:
                'npx hardhat anchoringcorefacet:getanchoredblock --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1 --blocknumber 100',
        },
        {
            ...
            params: '--governancediamond <address> --chainid <uint256>',
            example:
                'npx hardhat anchoringcorefacet:getlastanchoredblock --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1',
        },
        {
            name: 'anchoringcorefacet:registerchain',
            description:
                'Register a new chain for anchoring (requires ANCHORER_ROLE)',
            params: '--governancediamond <address> --chainid <uint256>',
            example:
                'npx hardhat anchoringcorefacet:registerchain --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1',
        },
        {
            ...
            example:
                'npx hardhat anchoringcorefacet:anchorblock --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1 --blocknumber 100 --blockhash 0xaaaa... --stateroot 0x1111...',
        },
        {
            name: 'anchoringcorefacet:anchorblocksbatch',
            description:
                'Anchor multiple blocks in batch (requires ANCHORER_ROLE)',
            params: '--governancediamond <address> --chainid <uint256> --blocknumbers <csv> --blockhashes <csv> --stateroots <csv>',
            example:
                'npx hardhat anchoringcorefacet:anchorblocksbatch --network <network> --governancediamond 0x00000000000000000000000000000000000015BE --chainid 1 --blocknumbers "100,101,102" --blockhashes "0xaaaa...,0xbbbb...,0xcccc..." --stateroots "0x1111...,0x2222...,0x3333..."',
        },
    ]
...
task(
    ...
    .setAction(async ({ governancediamond, chainid }) => {
        ...
        await registerChain(hre, governancediamond, chainid, signatureProvider)
