...
- **EIP-712**: Updated typehash includes `originalHash` in signature verification
  // Complete records with role tracking
  mapping(bytes32 => TsrRecord) private \_records; // originalHash => record
  mapping(bytes32 => bytes32) private \_refToOriginalHash; // externalRefId => originalHash
  mapping(address => uint256) private \_nonces;
  TsrData[] private \_stampedList;

                                                                                                                                                                                                                                                                                                                                                                                                                                                        <<<<<<< HEADstruct TsrRecord {
                                                                                                                                                                                                                                                                                                                                                                                                                                                            TsrData data;
