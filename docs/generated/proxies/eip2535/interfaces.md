...
| Name | Type | Description |
| ---- | ---- | ----------- |
| facets_ | struct IDiamondLoupe.Facet[] | An array of `Facet` structures containing:                 - `facetAddress`: The address of the facet.                 - `functionSelectors`: The function selectors it supports. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| facetFunctionSelectors_ | bytes4[] | An array of function selectors (as `bytes4`) supported by the specified facet. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| facetAddresses_ | address[] | An array of addresses representing the facets in the diamond. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| facetAddress_ | address | The address of the facet that supports the selector, or `address(0)` if not found. |
