...
_Exposes external interface for burning tokens and burning from another account.
     - Should be registered in the diamond with all required selectors for burnable logic._
