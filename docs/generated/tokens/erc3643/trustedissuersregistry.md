...
Interface to manages a registry of trusted claim issuers and the claim topics they are authorized to issue

_Trusted issuers lifecycle management and verification logic_
