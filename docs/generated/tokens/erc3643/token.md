...
| setOnchainID(address)                                   | IERC3643Infrastructure                          |
| pause()                                                 | IPause                                          |
| unpause()                                               | IPause                                          |
...
| onchainID() view returns (address)                      | IERC3643Infrastructure                          |
| symbol() view returns (string)                          | IERC20Extended                                  |
| version() view returns (string)                         | IERC3643Infrastructure                          |
