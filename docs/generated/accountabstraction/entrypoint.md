...
| Name | Type | Description |
| ---- | ---- | ----------- |
| interfaces_ | bytes4[] | Array of supported ERC165 interface identifiers. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| businessId_ | bytes32 | Resolver key for the EntryPoint facet. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| selectors_ | bytes4[] | Array of function selectors implemented         by this facet. |
...
_Calls innerHandleOp via _callExecuteUserOp, interprets the
     ...
     - handles generic reverts with events and postOp._
