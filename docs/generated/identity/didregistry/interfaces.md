...
Raised when the DID is not derived from the provided proof

_This error prevents vanity DID attacks by ensuring the DID has the correct
     structure: [13 zero bytes | 19 payload bytes] where the payload matches
     the last 19 bytes of the proof (signature)_

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| did | bytes32 | The decentralised identifier that was provided |
