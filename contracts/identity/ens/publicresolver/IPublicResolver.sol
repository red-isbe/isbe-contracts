...
import {INameResolver} from './profiles/INameResolver.sol';
import {ITextResolver} from './profiles/ITextResolver.sol';
 ...
 */
interface IPublicResolver is INameResolver, ITextResolver {
    /**
