 ...
 * @notice Interface to manages a registry of trusted claim issuers and the claim topics they are authorized to issue
 * @dev Trusted issuers lifecycle management and verification logic
 * @author ISBE
 */
