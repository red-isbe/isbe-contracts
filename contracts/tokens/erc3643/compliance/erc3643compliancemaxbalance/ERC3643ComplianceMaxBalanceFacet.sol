...
import {ERC3643ComplianceMaxBalance} from './ERC3643ComplianceMaxBalance.sol';
 ...
 */
contract ERC3643ComplianceMaxBalanceFacet is ERC3643ComplianceMaxBalance, IEIP2535Introspection {
        ...
        returns (bytes4[] memory selectors_)
    {
        ...
        selectors_[--selectorsLength] = this.initializeERC3643ComplianceMaxBalance.selector;
        selectors_[--selectorsLength] = this.setMaxBalance.selector;
        selectors_[--selectorsLength] = this.maxBalance.selector;
        selectors_[--selectorsLength] = this.complianceCheckOnMaxBalance.selector;
    }
}