...
import {ERC3643ComplianceMaxBalanceInternal} from './ERC3643ComplianceMaxBalanceInternal.sol';
import {IERC3643ComplianceMaxBalance} from './IERC3643ComplianceMaxBalance.sol';
 ...
 */
abstract contract ERC3643ComplianceMaxBalance is IERC3643ComplianceMaxBalance, ERC3643ComplianceMaxBalanceInternal {
    /**
     ...
     */
    function complianceCheckOnMaxBalance(address to, uint256 amount)
        external
        view
        override
        ...
        returns (bytes4[] memory interfaces_)
    {
        ...
        interfaces_[--interfacesLength] = type(IERC3643ComplianceMaxBalance).interfaceId;
    }
}