...
interface IERC712 {
    ...
    /**
     * @dev Execute a transfer operation on behalf of a signer using EIP-712
     * @param from Address of the token sender
     * @param to Address of the token recipient
     ...
     * @return fields A byte string of concatenated field names
     ...
     * @return verifyingContract The address of the contract
     * @return salt A disambiguating salt (not used, returns bytes32(0))
     * @return extensions An array of EIP numbers (not used, returns empty)
     */
